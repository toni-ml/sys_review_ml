...
ml_method <- "stack_ensemble"

# naming convention vor data output
ml_model <- "pre_caretstack"
ml_model_path <- "02_pretrained_caretstack"
...
source(paste0("01rscripts/04ensemble/03_training_config/00_runs_pretrain_strack.R"))
