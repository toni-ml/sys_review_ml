...
ml_method <- "softvoting_ensemble"

# naming convention vor data output
ml_model <- "pre_softvoting"
ml_model_path <- "03_pretrained_softvoting"
...
source(paste0("01rscripts/04ensemble/03_training_config/00_runs_pretrain_softvoting.R"))
